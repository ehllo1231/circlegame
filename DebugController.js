...
export class DebugController {
  ...
  _buildPanel() {
    ...
    panel.innerHTML = `
      ...
      <div>
        ...
        <label style="margin-left:8px;">maxFlakes <input id="dbg-snow-max" type="number" step="1" min="0" style="width:80px"></label>
  ...
  _syncInputs() {
    ...
    $('#dbg-snow-max').value = SNOW?.maxFlakes ?? 160;
  ...
  _attachHandlers() {
    ...
    onNum('#dbg-snow-max', (v) => { SNOW.maxFlakes = Math.max(0, Math.round(v)); this.onChange('snow'); });
